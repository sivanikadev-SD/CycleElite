...
function setDir(d) {
  ...
  document.querySelectorAll('[data-rtl-icon]').forEach(el => {
    el.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 17H4"/><path d="m10 23-6-6 6-6"/><path d="M4 7h16"/><path d="m14 1 6 6-6 6"/></svg>`;
  });
}
